...
# Test connectivity to /students endpoint
print("🔍 Verifying API endpoint:", API)
try:
    test_response = requests.get(f"{API}/students")
    print("✅ Connection test successful.")
    print("Status Code:", test_response.status_code)
    print("Returned records:", len(test_response.json()))
